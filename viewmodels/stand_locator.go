...
func NewStandLocatorVM() *StandLocatorVM {
	return &StandLocatorVM{
		Head:   NewHead("Lemonade Stand Society - Stand Locator"),
		Header: NewHeader("stand_locator"),
		Footer: NewFooter(),
	}
}
